...
class DSMRasterizer:
    ...
    def set_min_normal_z(self, hard_gate: float, soft_upper: float) -> None: ...
    ...
    def get_validity_mask(self) -> numpy.typing.NDArray: ...
    ...
    def compute_gradient(self) -> numpy.typing.NDArray: ...

    def upsample_nn(
        self,
        coarse: numpy.typing.NDArray,
        coarse_w: int,
        coarse_h: int,
    ) -> numpy.typing.NDArray: ...
...
class SVOFuser:
    ...
    def refine_geometry(self, iters: int, lambda_reg: float) -> None: ...
