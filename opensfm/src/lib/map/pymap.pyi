...
class ShotMeasurements:
    ...
    @property
    def relative_altitude(self) -> Optional[float]: ...
    @relative_altitude.setter
    def relative_altitude(self, arg1: Optional[float]) -> None: ...
    @property
...
def parse_geolocation_file(
    content: str, dataset_images: List[str], crs: str) -> List[GeolocationData]: ...
