...
## 🫣 Known Issues
- Mesh support is experimental and still sub-optimal — the Surface Nets mesh (config: [`depthmap_fusion_mesh_enabled`](doc/configuration.md#fusion)) is on by default but can leave holes in empty regions
